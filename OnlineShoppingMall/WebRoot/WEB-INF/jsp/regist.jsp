...
<link href="${pageContext.request.contextPath}/statics/css/register.css"
	rel="stylesheet" type="text/css" />
</head>
<body>
		...
		<div class="span5">
			<div class="logo">
				<a href="http://localhost:8080/mango/"> <img
					src="${pageContext.request.contextPath}/statics/image/r___________renleipic_01/logo2.png"
					height="50" width="200" alt="网上商城">
				</a>
			</div>
		</div>
		<div class="span9">
			<div class="headerAd">
				<img
					src="${pageContext.request.contextPath}/statics/image/header.jpg"
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUsername()" /><span id="info"></span>
									</td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off" /><span id="passwordErr1"></span>
									</td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>确认密码:</th>
									<td><input id="repassword" type="password" name="repassword" class="text"
										maxlength="20" autocomplete="off" /><span id="passwordErr2"></span>
									</td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200" /><span id="emailErr"></span>
									</td>
								</tr>
								<tr>
									<th>姓名:</th>
								...
								<tr>
									<th>电话:</th>
									<td><input type="text" id="phone" name="phone"	class="text"/><span id="phoneErr"></span></td>
								</tr>
								<tr>
									<th>地址：</th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											...
											<span id="checkErr" style="color: red; font-size: small;"><s:actionerror /></span>
										</span>
									</td>
								</tr>
							<tr>
	...
	function checkForm(){
		...
		if(password == null || password == ''){
			...
			if(!pattern.test(password)){
				document.getElementById("passwordErr1").innerHTML="<font color='red'>密码要求：同时含有数字和字母，且长度要在8-16位之间</font>"
				return false;
			}
		...
		if(repassword != password){
			document.getElementById("passwordErr2").innerHTML="<font color='red'>两次密码输入不一致!</font>"
			return false;
		}else{
		...
		if(!phone==''){
			if(!rePhone.test(phone)){
				document.getElementById("phoneErr").innerHTML="<font color='red'>请输入正确的手机号码！</font>"
				return false;
			}else{
