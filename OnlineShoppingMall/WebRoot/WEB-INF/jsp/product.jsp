		...
		<div class="span18 last">
			...
			<div id="bar" class="bar">
				...
				<div id="introduction" name="introduction" class="introduction">
					...
					<div>
						<img src="${pageContext.request.contextPath}/statics/<s:property value="model.image"/>" width="450px" height="500px">
					</div>
				</div>
